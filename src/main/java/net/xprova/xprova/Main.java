...
import net.xprova.xprova.Manipulator;
import net.xprova.xprova.Manipulator2;
...
public class Main {
	...
	private static void doCMDWork(String verilogFile, String outputVerilogFile) throws Exception {

		System.out.println("input file  : " + verilogFile);

		System.out.println("output file : " + outputVerilogFile);

		GateLibrary library1 = new GateLibrary("faraday90nm");
		...
		Generator.generate(graph, outputVerilogFile);
	...
	private void doWork() throws Exception {
		...
		String outputVerilogFile = "D:\\dev\\cdctool\\synthesized\\design_synth_morphed.v";
		...
		runCmd("dot -Tsvg D:\\dev\\cdctool\\synthesized\\graph.dot -o D:\\dev\\cdctool\\synthesized\\graph.svg");
	...
	public static void printUsage() {
		...
		String[] usageMsgLines = {
				"xprova v0.0.1-SNAPSHOT",
				"",
				"Usage:",
				"  xprova source.v augmented.v",
//				"",
//				"Options:",
